...
class MALAnimeFixtures extends Fixture
{
    ...
    public function __construct(HttpClientInterface $httpClient, ParameterBagInterface $parameterBag)
    {
        ...
        // $this->url = $parameterBag->get('MAL_API_URL'); TODO("make env work")
        // $this->clientId = $parameterBag->get('MAL_CLIENT_ID'); TODO("make env work")
    }
            ...
            try {
                ...
                foreach ($data as $anime) {
                    $manager->persist((new Anime())
                        ...
                        ->setPicture($anime['node']['main_picture']['medium']));
                }
                $manager->flush();
            } catch (Exception $e) {
